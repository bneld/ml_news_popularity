...
class Algorithm:
	...
	def process_data(self):
		...
		X = news_articles[:,predictor_indices]
		y = news_articles[:, target_index]
	...
	def objective_plot(self, betas_cyclic, x, y):
		"""
	...
	def plot_error(self, betas_cyclic, x, y, title):
		"""
...
if __name__=='__main__':
	...
	print(x_train.dot(betas_cyclic[-1]))
	# betas_rand = algorithm.randcoorddescent(x_train, y_train, beta_init)
	algorithm.objective_plot(betas_cyclic, x_train, y_train)
	algorithm.plot_error(betas_cyclic, x_train, y_train, \
		'Mean Squared Error on Train Data')
	algorithm.plot_error(betas_cyclic, x_test, y_test, \
